...
const jsonDbPath = __dirnae + '/../data/pizzas.json'
...
router.get('/', (req, res, next) => {
  ...
  // return orderedMenu or MENU if orderedMenu is undefined
...
router.post('/', (req, res) => {
  ...
  const pizzas = parse(jsonDbPath, MENU);
  const lastItremIndex = pizzas?.length !== 0 ? pizzas.length -1 : undefined;
